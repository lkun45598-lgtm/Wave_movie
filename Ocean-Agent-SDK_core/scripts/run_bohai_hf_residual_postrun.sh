...
CONFIG_PATH="${ROOT_DIR}/Ocean-Agent-SDK_core/configs/bohai_xyz_2x/bohai_vz_sparsemask_2x_resshift_hf_residual_50ep_gpu0.yaml"
TRAIN_SESSION="${1:-bohai_hf_residual}"

RUN_DIR="${ROOT_DIR}/testouts/Resshift_SparseMask2xObserved_Vz_HFResidual_50ep"
PRED_DIR="${RUN_DIR}/predictions"
EVAL_DIR="${ROOT_DIR}/testouts/Resshift_HFResidual_50ep_eval"
