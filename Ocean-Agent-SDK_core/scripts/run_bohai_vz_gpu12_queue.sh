...
CONFIGS=(
  "${ROOT}/configs/bohai_xyz_4x/bohai_vz_4x_edsr_pgn_ddp_gpu12.yaml"
  "${ROOT}/configs/bohai_xyz_4x/bohai_vz_4x_fno2d_pgn_ddp_gpu12.yaml"
  "${ROOT}/configs/bohai_xyz_4x/bohai_vz_4x_swinir_pgn_ddp_gpu12.yaml"
)
...
export MPLCONFIGDIR=/tmp/mpl_bohai_vz_gpu12
