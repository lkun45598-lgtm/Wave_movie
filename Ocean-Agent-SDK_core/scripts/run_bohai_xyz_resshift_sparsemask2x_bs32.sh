...
GPU="${1:-3}"
SESSION="${2:-bohai_xyz_resshift_bs32_g${GPU}}"
...
CONFIG_PATH="${ROOT_DIR}/Ocean-Agent-SDK_core/configs/bohai_xyz_2x/bohai_xyz_sparsemask_2x_resshift_mse_aux_bs32_200ep_gpu0.yaml"
RUN_DIR="${ROOT_DIR}/testouts/Resshift_SparseMask2xObserved_XYZ_MSEAux_BS32_200ep"
