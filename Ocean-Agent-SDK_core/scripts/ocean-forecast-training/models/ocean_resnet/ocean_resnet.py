"""
@file ocean_resnet.py

@description ResNet-based model for ocean velocity prediction with BasicBlock and encoder-decoder structure.
@author Leizheng
@date 2026-02-27
@version 1.0.0
